	...
	if (!isset(_action.options)) {
		...
		.append($('<div class="form-group DawnSimulatorEngine">')
			...
			.append($('<div class="form-group DawnSimulatorEngine">')
				...
				.append($('<div class="col-sm-5">')
					.append($('<input type="text" class="expressionAttr form-control" data-l1key="configuration" data-l2key="DawnSimulatorEngineStartValue" placeholder="{{Valeur de départ de la simulation (0 par defaut)}}"/>')))).hide()
			.append($('<div class="form-group DawnSimulatorEngine">')
				...
				.append($('<div class="col-sm-5">')
					.append($('<input type="text" class="expressionAttr form-control" data-l1key="configuration" data-l2key="DawnSimulatorEngineEndValue" placeholder="{{Valeur d\'arret de la simulation (100 par defaut)}}"/>')))).hide()
			.append($('<div class="form-group DawnSimulatorEngine">')
				...
				.append($('<div class="col-sm-5">')
					.append($('<input type="text" class="expressionAttr form-control" data-l1key="configuration" data-l2key="DawnSimulatorEngineDuration" placeholder="{{Durée de la simulation}}"/>')))).hide()
			.append($('<div class="form-group">')
				.append($('<div class="col-lg-1">')
